<svg class="{{ $classes ?? '' }}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54.02 54.02" height="40px">
    <path class="colour-stroke" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="3px"
          d="M27,52.52A25.51,25.51,0,1,0,1.5,27,25.51,25.51,0,0,0,27,52.52"/>
    <path fill="#fff" class="colour-fill"
