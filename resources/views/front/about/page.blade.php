...
@section('content')
    ...
    <p class="body-type lh-copy colour-p f5 f4-ns mw7 center ph3 ph0-ns">In 2003 my eldest daughter was born. I found her birth to be an overwhelming and heavily medicalised experience which didn’t get any easier in the following months. Healing from a traumatic birth experience whilst caring for a ‘high-needs’ baby was exhausting! I became acutely aware of just how important information, rather than advice, and emotional support at this time of transition and adjustment are, especially in the months leading up to the birth.</p>
    <p class="body-type lh-copy colour-p f5 f4-ns mw7 center ph3 ph0-ns">On completion of my nursing qualification in 2004, among other things I worked as a childbirth educator and doula for an independent midwife practice in South Africa.</p>
    ...
    <p class="body-type lh-copy colour-p f5 f4-ns mw7 center ph3 ph0-ns">After much reflection I realised that providing information in a supportive and empowering manner in a full-time capacity is what is most important to me, and I decided to re-train specifically to work with women (and their partners) at this exciting – sometimes overwhelming, time in their lives.</p>
    <p class="ph3 ph0-ns strong-type mw7 colour-p center f4 f3-ns mt5">Record of Continuing Professional Development</p>
    <ul class="ph3 pl3-ns pr0-ns mw7 center pl0 tl body-type f5 f4-ns colour-p lh-copy education-list">
        <li class="mb2 mb0-ns">2013 VRQ level 2 in Mental Health Awareness</li>
